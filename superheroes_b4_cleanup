const superheroes = [
  ...
  },
  {
    ...
    alias: "-SmaShing-",
    img: "ttps://muonlione.fandom.com/pl/wiki/Horn_of_Urnii",
  },
  {
    alias: "Koukoumafka",
  ...
  {
    ablities: ["sweettooth", "great taste", "agility"],
